    ...
    <div className="grid md:grid-cols-2 min-h-screen">
      <div className="hero-content flex-col">
        <div className="w-full max-w-md">
          <h1 class="text-5xl font-bold">Make an appointment</h1>
          <p class="py-6 font-medium text-lg">Welcome to our clinic site</p>
          <p class="w-full  max-w-sm text-zinc-700">
          ...
          <div className="my-5">
            <button class="btn btn-primary rounded-xl mr-5">About us</button>
            <button class="btn btn-primary rounded-xl">Contact</button>
          </div>
          <div className="flex w-full h-12 relative">
            ...
            />
            <button class="btn btn-square rounded-r-xl h-full absolute right-0">
              <svg
